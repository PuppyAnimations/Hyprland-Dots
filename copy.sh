...
if hostnamectl | grep -q 'Chassis: desktop'; then
    ...
    ln -sf "$HOME/.config/waybar/configs/[BOT] Sleek" "$HOME/.config/waybar/config" 2>&1 | tee -a "$LOG"
...
while true; do
    ...
    case $WALL in
        [Yy])
            ...
            if git clone "https://github.com/PuppyAnimations/Wallpaper-Bank.git"; then
